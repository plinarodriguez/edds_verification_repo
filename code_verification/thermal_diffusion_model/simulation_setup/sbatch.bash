...
cp template/system/wallQ_pipeFluid  system/
cp template/system/wallQ_caseSolid  system/
...
# Also collect the heat flux quantities
chtMultiRegionFoam -postProcess -func wallQ_pipeFluid -time '0:'
chtMultiRegionFoam -postProcess -func wallQ_caseSolid -time '0:'

# convert to VTK
$FOAM_BIN/foamToVTK -region pipeFluid -fields '(T U)' -allPatches -time '0:'
$FOAM_BIN/foamToVTK -region caseSolid -fields '(T)'   -allPatches -time '0:'
