...
def temp_points(vtk_directory,z,time_steps, ratio,region):
    """
    ...
    directory_path = vtk_directory+'/'+region  #'/caseSolid'
    ...
    vtk_files = sorted([f for f in os.listdir(directory_path) if f.endswith(".vtk")])
    ...
    for file in vtk_files:
        ...
        dataset = pv.read(directory_path+'/'+file)
